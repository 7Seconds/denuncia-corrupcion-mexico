...
{
    [super viewDidLoad];
    UILabel *label = [[MenuViewController menuController] labelWithTitle:@"SFP"];
    [label setTextColor:[UIColor darkGrayColor]];
    self.navigationItem.titleView = label;
    
    UIImage *rightImage = [UIImage imageNamed:@"sfpMenuButton.png"];
    ...
    SFPChildViewController *initialViewController = [self viewControllerAtIndex:0];
...
- (SFPChildViewController *)viewControllerAtIndex:(NSUInteger)index {
    
    SFPChildViewController *childViewController = [[SFPChildViewController alloc] initWithNibName:@"SFPChildViewController" bundle:nil];
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController {
    ...
    NSUInteger index = [(SFPChildViewController *)viewController index];
